...
# For experiment
export X86_SIGNAL_PATH='/path/to/signal/directory/in/x86' # Signal path in X86 host.
export ARM_SIGNAL_PATH='/path/to/signal/directory/in/arm' # Signal path in ARM SoC.
