...
static void check_default_privs(void)
{
    ...
    msg_info ("[ASSISE] Let's getpwnam!");
    pwd = getpwnam(var_default_privs);
    // msg_info ("[ASSISE] var_default_privs: %s, pwd:%p, pwd:%s", var_default_privs, pwd, pwd->pw_name); 
    msg_info ("[ASSISE] var_default_privs: %s, pwd:%p", var_default_privs, pwd);
