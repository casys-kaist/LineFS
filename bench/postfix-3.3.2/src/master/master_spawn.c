...
void    master_spawn(MASTER_SERV *serv)
{
    ...
    char *assise_env;
    char *const assise_envp[] = {
        //"LD_LIBRARY_PATH=/usr/local/lib:/home/yulistic/git_repos/assise/libfs/lib/nvml/src/nondebug/:/home/yulistic/git_repos/assise/shim/glibc-build/:/home/yulistic/git_repos/assise/libfs/src/storage/spdk/:/home/yulistic/git_repos/assise/libfs/lib/rdma/librdma.so",
        //"LD_PRELOAD=/home/yulistic/git_repos/assise/shim/libshim/libshim.so:/home/yulistic/git_repos/assise/libfs/lib/jemalloc-4.5.0/lib/libjemalloc.so.2:/home/yulistic/git_repos/assise/libfs/lib/rdma/librdma.so:/usr/lib/librdmacm.so.1:/usr/lib/libibverbs.so.1:/usr/lib/x86_64-linux-gnu/libnl-route-3.so.200:/lib/x86_64-linux-gnu/libnl-3.so.200",
        //"LD_PRELOAD=/home/yulistic/git_repos/assise/shim/libshim/libshim.so:/home/yulistic/git_repos/assise/libfs/lib/jemalloc-4.5.0/lib/libjemalloc.so.2:/home/yulistic/git_repos/assise/libfs/lib/rdma/librdma.so:/usr/lib/librdmacm.so.1:/usr/lib/libibverbs.so.1 /usr/libexec/postfix/local -l -t unix -v -D"
        //"LD_PRELOAD=/home/yulistic/git_repos/assise/shim/libshim/libshim.so:/home/yulistic/git_repos/assise/libfs/lib/jemalloc-4.5.0/lib/libjemalloc.so.2:/home/yulistic/git_repos/assise/libfs/lib/rdma/librdma.so:/usr/lib/librdmacm.so.1:/usr/lib/libibverbs.so.1",
        "LD_LIBRARY_PATH=/usr/lib64:/usr/local/lib:/root/projects/assise/libfs/lib/nvml/src/nondebug/:/root/projects/assise/shim/glibc-build-all/:/root/projects/assise/libfs/src/storage/spdk/:/root/projects/assise/libfs/lib/rdma",
        "LD_PRELOAD=/root/projects/assise/shim/libshim/libshim.so:/root/projects/assise/libfs/lib/jemalloc-4.5.0/lib/libjemalloc.so.2:/root/projects/assise/libfs/lib/rdma/librdma.so:/usr/lib64/librdmacm.so.1:/usr/lib64/libibverbs.so.1:/usr/lib64/libnl-route-3.so.200:/usr/lib64/libnl-3.so.200:/root/projects/assise/shim/glibc-build-all/resolv/libresolv.so.2",
        NULL
    };
...
#ifdef MLFS
        // Assise support. Check if it is local process.
        if (strcmp(serv->ext_name, "local") == 0) {
            msg_info("[ASSISE] Do execve local process.");
            execve(serv->path, serv->args->argv, assise_envp);
        } else {
            msg_info("[ASSISE] Do execve other process.");
